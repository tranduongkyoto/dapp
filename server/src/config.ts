...
export class Config {
    ...
    'jhipster.mail.from' = 'dapp@localhost';
    'jhipster.swagger.default-include-pattern' = '/api/.*';
    'jhipster.swagger.title' = 'dapp API';
    'jhipster.swagger.description' = 'dapp API documentation';
    ...
    'eureka.instance.appname' = 'dapp';
    'eureka.instance.instanceId' = 'dapp:${random.value}';
